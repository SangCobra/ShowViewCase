...
//                    .addCustomView(R.layout.fab_description_view, Gravity.CENTER);
    ...
    private void showcaseTextView() {
        showcaseViewBuilder.setTargetView(textView)
                ...
                .setMarkerDrawable(getDrawable(R.drawable.arrow_up), Gravity.BOTTOM)
                .setDrawableLeftMargin(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 8, getResources().getDisplayMetrics()))
                .addCustomView(R.layout.textview_description_view, Gravity.BOTTOM, getResources().getDimensionPixelSize(R.dimen._4sdp), getResources().getDimensionPixelSize(R.dimen._4sdp), getResources().getDimensionPixelSize(R.dimen._4sdp) ,0)
    ...
    private int getPxSize(int dbValue){
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dbValue, getResources().getDisplayMetrics());
    }
